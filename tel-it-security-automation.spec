...
mkdir -p %{buildroot}%{_datadir}/ansible/%{name}/roles
...
cp -rp hardening-linux-server %{buildroot}%{_datadir}/ansible/%{name}/roles/
cp -rp hardening-ssh %{buildroot}%{_datadir}/ansible/%{name}/roles/
mv %{buildroot}%{_datadir}/ansible/%{name}/roles/hardening-linux-server/playbook.yml %{buildroot}%{_datadir}/ansible/%{name}/playbooks/hardening-linux-server/
mv %{buildroot}%{_datadir}/ansible/%{name}/roles/hardening-ssh/playbook.yml %{buildroot}%{_datadir}/ansible/%{name}/playbooks/hardening-ssh/
...
mv %{buildroot}%{_datadir}/ansible/%{name}/roles/hardening-*/TelekomSecurity_SecReq*.txt %{buildroot}%{_datadir}/doc/%{name}/
...
%attr(755, root, root) %{_datadir}/ansible/%{name}/roles/hardening-linux-server/testing/check_linux.sh
%attr(755, root, root) %{_datadir}/ansible/%{name}/roles/hardening-ssh/testing/check_ssh.sh
